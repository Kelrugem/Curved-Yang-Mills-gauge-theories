    ...
    \begin{titlepage}
        ...
        \begin{center}
            ...
            {\href{mailto:simon.fischer@mathematik.uni-goettingen.de}{\texttt{simon.fischer@mathematik.uni-goettingen.de}}
						\\
						\orcidlink{0000-0002-5859-2825}: \href{https://orcid.org/0000-0002-5859-2825}{0000-0002-5859-2825}
						}
                }}
        \end{center}
        \vskip0.8cm
...
\tcbsubtitle[before skip=\baselineskip]{\cite[reduced definition of \S 16.1, page 113]{DaSilva}}
%\leavevmode\newline
...
We want to use Thm.\ \ref{thm:DiffOfLGBAction} now in order to understand what Eq.\ \eqref{PTHomomNEw} implies about the corresponding horizontal distribution of $\mathcal{P}$ in sense of right-translations:
\bas
\mathrm{D}_{(p, g)}\Phi\mleft(
	X, 
	Y
