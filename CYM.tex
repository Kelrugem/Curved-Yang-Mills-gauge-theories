...
Finally, we come to the last part of the \textit{basics} for LGBs and their notions needed in this paper. We essentially are left to construct fundamental vector fields, and with their help we can express the differential of the multiplication $\mathcal{G} * \mathcal{G} \to \mathcal{G}$.
