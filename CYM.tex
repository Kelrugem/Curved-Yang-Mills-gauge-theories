...
\eas
If one wants to denote the base points, then recall our discussion before Def.\ \eqref{definitionOfFlipMap} and observe
\bas
\mleft.\frac{\mathrm{d}}{\mathrm{d}t}\mright|_{t=0} \mleft.\frac{\mathrm{d}}{\mathrm{d}s}\mright|_{s=0} ( F \circ \alpha )
&=
\mleft.\frac{\mathrm{d}}{\mathrm{d}t}\mright|_{t=0} \mleft( \mathrm{D}_{\alpha(t, 0)} F \circ \mleft.\frac{\mathrm{d}}{\mathrm{d}s}\mright|_{s=0}\alpha \mright)
\\
&=
\eas
\end{remarks}
