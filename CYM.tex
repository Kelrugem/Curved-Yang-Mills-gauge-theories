...
Let $G$ be a Lie group, $M$ a smooth manifold, and an LGB $\mathcal{G}$ which acts on the right on another $G$-fibre bundle $\mathcal{P}$
\begin{center}
	\begin{tikzcd}
	G \arrow{r} & \mathcal{P} \arrow{d}{\pi_{\mathcal{P}}} & \arrow[bend right]{l} \mathcal{G} \arrow{d} & \arrow{l} G \\
	& M & M
	\end{tikzcd}
\end{center}
...
\begin{remarks}{Discussing the definition of $\mathcal{G}$-principal bundles}{LGBPrincDefDiscussion}
...
\begin{enumerate}
	...
	We will call such an atlas and its charts a \textbf{principal bundle atlas} and \textbf{principal bundle charts} for $\mathcal{P}$, respectively. For simplicity we may also refer to $\varphi_i$ as principal bundle chart.
