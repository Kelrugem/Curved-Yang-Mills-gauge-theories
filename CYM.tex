...
\bas
\mathrm{pr}_2^!\pi^{\mathrm{vert}} &\in \Omega^1\bigl(f^*\mathcal{G}; \mathrm{pr}_2^*\mleft( \mathrm{V}\mathcal{G} \mright)\bigr)
\eas
is a projection onto $\mathrm{V}\mleft( f^*\mathcal{G} \mright)$, and gives therefore rise to a horizontal distribution on $f^*\mathcal{G}$, the \textbf{pullback connection on $f^*\mathcal{G}$}. 
...
Let $f: N \to M$ be a smooth map from another smooth manifold $N$. 
\end{remarks}
%
