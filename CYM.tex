...
\begin{tikzpicture}[scale=1.2]
	...
	\end{center}
	\end{minipage}
	Push-forward of horizontal tangent vector with constant section (left) and general section(right).
\end{figure}
