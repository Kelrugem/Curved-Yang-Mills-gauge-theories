...
\leavevmode\newline
The idea of the proof is similar to the proof of the "classical" statement; following the structure of \cite[\S 5.5, Lemma 5.5.5, page 276]{Hamilton}. That is, we will look at vertical and horizontal tangent vectors and their mixed terms; recall Def.\ \ref{def:GaugeBosonsOnLGBPrincies} and Thm.\ \ref{thm:OurConnectionHasAUniqueoneForm}.
