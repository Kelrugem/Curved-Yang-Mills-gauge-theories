...
Let $\mathcal{G} \stackrel{\pi}{\to} M$ be an LGB over a smooth manifold $M$. The \textbf{vertical Maurer-Cartan form $\mu_\mathcal{G}$} is then defined to be an element of $\Omega^1($
\end{definitions}
