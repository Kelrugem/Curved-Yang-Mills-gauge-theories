...
\eas
for all $X \in \mathrm{T}_pN, Y\in \mathrm{T}_vF$. Hence, we have derived that $\mathrm{T}_{(p, v)}\mleft( f^*F \mright)$ is a subset of the set of such pairs $(X, Y)$. That all tangent vectors are of that form can be derived 
\end{proof}
