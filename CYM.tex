...
H^!A
&=
\sAd_{\mathrm{pr}_2\circ\sigma^H}(A) 
...
&=
\mathcal{r}_{\widetilde{\sigma}_p*}(X)
	+ \mleft.{\oversortoftilde{\Delta^{\pi^*\mathcal{G}}\sigma^H }}\mright|_{H(p)}
\\
&=
\mathcal{r}_{\widetilde{\sigma}_p*}(X)
	+ \mleft.{\oversortoftilde{\mleft(\pi^*\Delta\mright)\sigma^H }}\mright|_{H(p)}
\eas
for all $X \in \mathrm{T}_p\mathcal{P}$, where $\sigma$ is a (local) section of $\mathcal{G}$ so that $\sigma_x = \widetilde{\sigma}_p = \mathrm{pr}_2\mleft( \sigma^H_p \mright)$. Then
\bas
