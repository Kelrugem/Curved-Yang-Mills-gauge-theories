...
Of course, we expect certain properties, naturally generalized by our previous discussion; especially recall all the discussion around the modified push-forward via right-translations $\mathcal{r}$, Def.\ \ref{def:WeModTheRIghtPush}.
