...
\eas
where $Y \coloneqq \mathrm{D}_p\pi(X)$, $\mathcal{r}_\sigma$ denotes the modified pushforward via $\mu_{\mathcal{G}}^{\mathrm{tot}}$ as usual, and we made use of $A$ being a connection 1-form w.r.t.\ $\mu_{\mathcal{G}}^{\mathrm{tot}}$.
\end{proof}
