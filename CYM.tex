...
\bas
\mathrm{Dpr}_1 \circ \mathrm{pr}_2^!\pi^{\mathrm{vert}} &= 0,&
\mathrm{Dpr}_2 \circ \mathrm{pr}_2^!\pi^{\mathrm{vert}} &= \pi^{\mathrm{vert}}.
\eas 
...
\mright),
\eas
and hence, making use of that $f^*\mathcal{G}$ is an embedded submanifold of $N \times \mathcal{G}$,
\bas
