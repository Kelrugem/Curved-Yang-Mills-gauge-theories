...
Instead of calculating directly how $A_{s_i}$ and $A_{s_j}$ are related we want to use Thm.\ \ref{thm:GaugeTrafoOfGaugeBoson}. For this observe the following proposition.
