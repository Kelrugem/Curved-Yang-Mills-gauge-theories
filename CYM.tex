...
Multiplicative connections will be introduced later in more detail when we discuss the field strength.
...
Recall that LGBs themselves are principal bundles as in \ref{ex:TrivialPrincAsLGB}. Let $G, H$ be Lie groups, $P \to M$ a principal $G$-bundle over a smooth manifold $M$, and $\psi$ a $G$-representation on $H$. Then we have the LGB associated to the principal bundle $P$ and the representation $\psi$ on $H$
\begin{center}
	\begin{tikzcd}
