...
\eas
for all $g \in \mathcal{G}_x$, also using Remark \ref{rem:ModRightPushOnVertic}. Thus,
\bas
...
\eas
for all $p \in \mathcal{P}_x$, $\sigma \in \Gamma(\mathcal{G})$, $v \in \mathcal{g}_x$ and $X_p \in \mathrm{H}_p\mathcal{P}$.
\end{proof}
