...
\mleft(\sigma^* \mu_{\mathcal{G}}^{\mathrm{tot}} \mright) \circ \mathrm{D}\sigma
\eas
$\mu_{\mathcal{G}}^{\mathrm{tot}}$ a section of $\mathrm{T}^*\mathcal{G} \times \pi^*\mathcal{g} \to \mathcal{G}$, then $\sigma^*\mu_{\mathcal{G}}^{\mathrm{tot}} = \mu_{\mathcal{G}}^{\mathrm{tot}} \circ \sigma$

$\mu_{\mathcal{G}}^{\mathrm{tot}}: \mathcal{G} \times_{\mathcal{G}} \mathrm{T}\mathcal{G} \to \pi^*\mathcal{g}$, then
\bas
\Delta \sigma
&=
\mu_{\mathcal{G}}^{\mathrm{tot}} \circ (\sigma, \mathrm{D}\sigma)
\eas
\bas
\mleft.\frac{\mathrm{d}}{\mathrm{d}t}\mright|_{t=0} \Delta\e^{t\nu_x}
&=
\mathrm{D}_{(e_x, \mathrm{D}_xe)}\mu_{\mathcal{G}}^{\mathrm{tot}} \circ (\nu_x, \mathrm{D}_x \nu )
\eas

Now let $\mu \in \Gamma(\mathcal{g})$ and $\alpha, \beta \in \mathbb{R}$, then we can derive
\bas
\mleft( \Delta \e^{t (\alpha \nu + \beta \mu)} \mright)_x
\eas
and so
\bas
\mleft.\nabla^{\mathcal{G}}(\alpha \nu + \beta \mu)\mright|_x
&=
\eas
\end{proof}
