...
\lambda ~ \mleft.\nabla^{\mathcal{G}}_{X} \nu \mright|_x
	+ \kappa ~ \mleft.\nabla^{\mathcal{G}}_{Y} \nu \mright|_x
\eas
for all $\lambda, \kappa \in \mathbb{R}$, using Remark \ref{rem:TangentLifts}, \ref{rem:TotalDerivativesAreLinearWithRTOtherLinearStructure} and \ref{rem:BothLinearStructuresTheSameOnTheVerticalBundle}.
\end{proof}
...
Y^i \mleft.\frac{\partial}{\partial \mleft(\pi_{\mathrm{T}M}^*x^i\mright)}\mright|_{X_p}
	+ Y^j \frac{\partial X^i}{\partial x^j} \mleft.\frac{\partial}{\partial \mleft(\mathrm{d}x^i\mright)}\mright|_{X_p},
\eas
thus,
\bas
...
Y^i \mleft.\frac{\partial}{\partial \mleft(\pi_{\mathrm{T}M}^*x^i\mright)}\mright|_{\lambda X_p + \kappa W_p}
	+ Y^j \frac{\partial \mleft( \lambda X^i + \kappa W^i \mright)}{\partial x^j} \mleft.\frac{\partial}{\partial \mleft(\mathrm{d}x^i\mright)}\mright|_{\lambda X_p + \kappa W_p}
\\
&=
...
Y^i \mleft.\frac{\partial}{\partial \mleft(\pi_{\mathrm{T}M}^*x^i\mright)}\mright|_{f(p)X_p}
	+ f(p) ~ Y^j \frac{\partial X^i}{\partial x^j} \mleft.\frac{\partial}{\partial \mleft(\mathrm{d}x^i\mright)}\mright|_{f(p)X_p}
	+ Y^j X^i \frac{\partial f}{\partial x^j} \mleft.\frac{\partial}{\partial \mleft(\mathrm{d}x^i\mright)}\mright|_{f(p)X_p}
\eas
...
(fX)_T(Y)
&=
f(p) ~ X^i \mleft.\frac{\partial}{\partial \mleft(\pi_{\mathrm{T}M}^*x^i\mright)}\mright|_{Y}
	+ fY^j \frac{\partial X^i}{\partial x^j} \mleft.\frac{\partial}{\partial \mleft(\mathrm{d}x^i\mright)}\mright|_{Y}
	+ Y(f) ~ X^i \mleft.\frac{\partial}{\partial \mleft(\mathrm{d}x^i\mright)}\mright|_{Y}
\eas
\end{remarks}
