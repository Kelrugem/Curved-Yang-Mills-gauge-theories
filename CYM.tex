...
\sigma_{p \cdot g}^\tau
&=
\mathcal{c}_{\mleft(\Phi^{-1}_{s}(p \cdot g)\mright)^{-1}} \mleft( p \cdot g, \tau_{\pi(p \cdot g)} \mright)
\\
&=
\mathcal{c}_{g^{-1}\cdot\mleft(\Phi^{-1}_{s}(p)\mright)^{-1}} \mleft( p \cdot g, \tau_x \mright)
\eas
