...
Gauge transformations now naturally arise in a change of the gauge $s$. So, let $U_i$ and $U_j$ be two open subsets of $M$ so that $U_i \cap U_j \neq \emptyset$. Then there is a $\sigma_{ji} \in \Gamma\mleft( \mleft.\mathcal{G}\mright|_{U_i \cap U_j} \mright)$ such that
\bas
s_i
&=
s_j \cdot \sigma_{ji}.
\eas
Pointwise this is clear by the definition of principal bundles
