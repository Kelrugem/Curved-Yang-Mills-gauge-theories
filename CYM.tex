...
\eas
Due to the fact that we have a simply transitive $\mathcal{G}$-action on $\mathcal{P}$, it follows that the connection on $\mathcal{G}$ is multiplicative. We will later introduce multiplicative connections in more detail when we discuss the field strength.
\end{remarks}
