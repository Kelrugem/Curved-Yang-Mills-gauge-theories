...
As we have seen, elements of $L(\mathcal{G})$ are as usual therefore determined by their value at $e_M$:
...
\mathcal{g}.
\eas
By this we also know that $\mathrm{V}\mathcal{G}$ is trivial if and only if $\mathcal{g}$ is trivial; as also argued in \cite[\S 3.5, discussion after Cor.\ 3.5.4, page 121]{mackenzieGeneralTheory}. For sections we therefore get
\bas
