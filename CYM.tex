...
\begin{proof}
\leavevmode\newline
$\bullet$ Let us first assume that $\mathrm{H}\mathcal{G}$ is an Ehresmann connection, therefore we now initially show that the associated total Maurer-Cartan form is multiplicative. 
\end{proof}
