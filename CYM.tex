...
\begin{proof}
\leavevmode\newline
That $H^!F$ is the field strenght related to $H^!A$ follows quickly by the same calculation as for proving Eq.\ \eqref{PullbackofMCGeneralCurvPlusExtra}, using $\pi \circ H = \pi$,
\bas
H^!F
&=
