...
\begin{remark}
\leavevmode\newline
The structure on the right hand side is again due to denoting the base point in pullback bundles; one may decide to drop the base point for simplicity in the notation. Since the base point is clear by context, one may also just write
\bas
\mathrm{Ad}_{g^{-1}} \circ \pi_{\mathcal{G}}^!\zeta
\eas
...
\coloneqq
\mleft( g, \mathrm{Ad}_{g^{-1}} \circ \xi_x \circ \mathrm{D}_g \pi_{\mathcal{G}} \mright)
...
\leavevmode\newline
The idea of the proof is similar to the proof of a statement about when two multiplicative 2-forms\footnote{See Rem.\ \ref{rem:SimplicialDifferentialStuff}; multiplicative is related to closedness w.r.t.\ a differential. However, we will not need this general notion.} are equal, see \textit{e.g.}\ \cite[\S 3, Cor.\ 3.4]{bursztyn2004integration}. That is, we now first discuss under what conditions 
\bas
...
$\bullet$ Therefore we now discuss the behaviour of $\omega$ restricted to non-vertical tangent vectors. For a given $g \in \mathcal{G}_x$ ($x \in M$) define
\bas
...
\eas
making use of that this calculation is pointwise at $x \in M$ just a standard derivative in the vector space $\mathcal{g}_x$ and that $\Delta e \equiv 0$ by Remark \ref{rem:baseManifoldHoriz}. In a similar fashion,
\bas
...
\mleft[ \mleft[\Delta\sigma, \nu \mright]_{\mathcal{g}} \stackrel{\wedge}{,} \Delta\sigma \mright]_{\mathcal{g}}
	+ \mleft[ \Delta \sigma \stackrel{\wedge}{,} \mleft[\Delta\sigma, \nu \mright]_{\mathcal{g}} \mright]_{\mathcal{g}}
	+ \mleft[ \Delta \sigma \stackrel{\wedge}{,} \nabla^{\mathcal{G}}\nu \mright]_{\mathcal{g}}
	+ \mleft[ \nabla^{\mathcal{G}}\nu \stackrel{\wedge}{,} \Delta \sigma \mright]_{\mathcal{g}}
\eas
\end{proof}
