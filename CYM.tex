...
In order to understand what has to be changed, let us look at a very trivial LGB and action thereof. We will now discuss the trivial LGB $\mathcal{G}$ given by
\begin{center}
	\begin{tikzcd}
