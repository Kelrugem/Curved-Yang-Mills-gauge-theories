...
\ea
where $\tau$ is any additional (local) section of $f$\footnote{That is, $f \circ \tau = \mathds{1}_M$.} with $\tau_x = p$.
\end{theorems}
...
\subsection{Principal fibre bundles with structural LGB}
