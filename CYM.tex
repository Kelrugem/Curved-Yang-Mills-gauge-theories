...
\eas
That $[X, Y]$ is a vertical vector field, that is, an element of the kernel of $\mathrm{D}\pi$, is a basic fact, see \textit{e.g.}\ \cite[Proposition A.1.49; page 615]{Hamilton}.
\end{proof}
