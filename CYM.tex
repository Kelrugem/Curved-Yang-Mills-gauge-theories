...
\eas
This map is a diffeomorphism; we discussed this in more generality in Rem.\ \ref{SmoothnessOfACtionTranslations}. Observe that for vertical vector fields $Y \in \Gamma(\mathrm{V}\mathcal{G})$ we have
%\bas
...
\begin{remark}
\leavevmode\newline
The assumption about $f$ being a surjective submersion is done in order to assure the existence of $\tau$; see the proof for more details.
\end{remark}
