...
The global section $e$ of $\mathcal{G}$ so that $e_p$ is the neutral element of $\mathcal{G}_p$ will be labelled as the \textbf{neutral section (of $\mathcal{G}$)}; we may also denote it by $e^{\mathcal{G}}$.
\end{definitions}
